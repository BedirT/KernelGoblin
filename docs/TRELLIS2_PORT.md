...
| Sparse-structure flow | Verified mixed-precision native execution | 4,096 tokens and all 22 model calls; F32 SDPA plus F32 final velocity projection restores the unchanged trajectory gates; occupancy IoU `0.718923`; exact cross-K/V caching was evaluated and left off by default |
